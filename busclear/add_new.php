...
<body>
    <div class="container my-5"></div>
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col">                 
                <a class='btn btn-primary btn-sm' href='/mis/busclear/busclearform.php'>Generate</a> 
                    <a class="btn btn-outline-primary" href="/mis/busclear/businessclearance.php" role="button">Cancel</a>
                </div>
            </div>
        </form>
    </div>
