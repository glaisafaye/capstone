            ...
            <form action="code.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="types" name="types" placeholder="Enter Type of Business Clearance">
                    </div>
                    <div class="form-group mb-3">
                        <label class="control-label">OR Number:</label>
                        <input type="number" class="form-control" id="orNo" name="orNo" placeholder="Enter OR Number">
                    </div>
                    <div class="form-group mb-3">
                        <label class="control-label">Amount Paid:</label>
                        <input type="number" class="form-control" id="amount" name="amount" placeholder="Enter Amount Paid">
                    </div>
                    <div class="form-group mb-3">
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "
                                                    <tr>
                                                        ...
                                                        <td>{$row['validDate']}</td>
                                                        <td>
                                                            <a class='btn btn-outline-success btn-sm' href='/mis/busclearance/generate_business.php?resident_id={$row['id']}'>Generate</a>
                                                        </td>
                                                    </tr>
                                                    ";
                                        }
