...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($clearanceNo) || empty($residentid) || empty($purpose) || empty($orNo)) {
        ...
        if (!$result) {
            ...
            $successMessage = "Indigent added correctly";
...
<body>
    <div class="container my-5">
        ...
        <form method="post">
            ...
            <div class="row">
                <div class="col">                 
                <a class='btn btn-primary btn-sm' href='/mis/brgyin/brgyin.php'>Generate</a> 
    ...
    <script>
        document.getElementById('addNewButton').addEventListener('click', function() {
            // Redirect to a new page or perform any other action for adding a new item.
            window.location.href = '/mis/brgyin/add_new.php'; // Change the URL accordingly
        });
    </script>
</body>
</html>
